...
<form:form name="submitForm" method="POST" class="form login">
    ...
    <p id = "InvalidData">Wrong login or password</p>
    <div class="form__field">
      <input type="submit" value="Sign In">
    </div>
</form:form>

  <p class="text--center">Don't have an account? <a href="/reg">Sign up now</a> <svg class="icon"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="assets/images/icons.svg#arrow-right"></use></svg></p>
